...
@Component({
  selector: 'app-lista-admin-screen',
  templateUrl: './lista-admin-screen.component.html',
  styleUrls: ['./lista-admin-screen.component.scss']
})
export class ListaAdminScreenComponent implements OnInit {
  ...
  public delete(idUser: number){
    ...
    dialogRef.afterClosed().subscribe(result => {
      if(result.isDelete){
        ...
        //Recargar página
        alert("Administrador eliminado Corrcetamente");
