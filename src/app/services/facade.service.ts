...
const session_cookie_name = 'proyecto-tiendify-token';
const user_email_cookie_name = 'proyecto-tiendify-email';
const user_id_cookie_name = 'proyecto-tiendifi-user_id';
const user_complete_name_cookie_name = 'proyecto-tiendify-user_complete_name';
const group_name_cookie_name = 'proyecto-tiendify-group_name';
const codigo_cookie_name = 'proyecto-tiendify-codigo';
